...
def getData(path, foldlist):
    ...
    for i, image_path in enumerate(foldlist):
        ...
        # image16 = imread(os.path.join(file_name + '.png'), as_grey=True)
...
def create_train_test_data():
    ...
    train_images, train_masks, train_ids = getData(os.path.join(raw_data_path, images_dir), train_list)
    test_images, test_masks, test_ids = getData(os.path.join(raw_data_path, images_dir), test_list)
